  ...
  return (
    <div style={{
      ...
      <div className="card" style={{ maxWidth: '500px', width: '100%', padding: '50px 32px', textAlign: 'center', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.5)' }}>
        ...
        <h2 style={{ fontSize: '2.5rem', color: 'var(--primary)', marginBottom: '8px' }}>Welcome Back</h2>
        <p style={{ color: 'var(--text-muted)', fontSize: '1.2rem', marginBottom: '40px' }}>Sign in to CareAssistant</p>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <button type="submit" className="btn btn-success" style={{ marginTop: '16px' }}>Log In</button>
        </form>

        <p style={{ marginTop: '32px', fontSize: '1.1rem' }}>
          No account yet? <Link to="/register" style={{ color: 'var(--primary)', fontWeight: 'bold' }}>Register Here</Link>
        </p>
      </div>
    </div>
  );
